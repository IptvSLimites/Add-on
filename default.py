...
def getSources():
        ...
        try:
            ...
            #addDir('[COLOR yellow][B]FILMES[/COLOR][/B]','',201,'https://i.imgur.com/Wjddv1h.png',FANART,'','','','')
			#addDir('[COLOR yellow][B]RADIOS ONLINE[/COLOR][/B]','LINKS AQUI',201,'https://i.imgur.com/gBhd0kv.png',FANART,'','','','')
            #addDir('[COLOR yellow][B]SERIADOS[/COLOR][/B]','LINKS AQUI',201,'https://i.imgur.com/4g31XOo.png',FANART,'','','','')
