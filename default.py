...
def getSources():
        ...
        try:
            ...
            addDir('[COLOR yellow][B]FILMES[/COLOR][/B]','https://192.168.1.7',201,'https://i.imgur.com/Wjddv1h.png',FANART,'','','','')
			addDir('[COLOR yellow][B]RADIOS ONLINE[/COLOR][/B]','http://256.129.1.10',201,'https://i.imgur.com/gBhd0kv.png',FANART,'','','','')
            addDir('[COLOR yellow][B]SERIADOS[/COLOR][/B]','http://196.10.10.40',201,'https://i.imgur.com/4g31XOo.png',FANART,'','','','')
